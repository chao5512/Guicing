...
import demos.utils.Closer;
import demos.utils.JvmUtils;
import demos.utils.RE;
 ...
 *
 * Functionally equivalent to wrapping {@link CombiningSequence} around a
...
{
  private static final Logger LOG = LoggerFactory.getLogger(ParallelMergeCombiningSequence.class);
   ...
   * CombiningSequence, where the {@link Ordering} is used to both set the sort
