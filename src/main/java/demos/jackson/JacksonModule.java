...
import demos.guice.LazySingleton;
import demos.guice.annotations.Json;
import demos.guice.annotations.Smile;
...
public class JacksonModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(ObjectMapper.class).to(Key.get(ObjectMapper.class, Json.class)).in(Singleton.class);
